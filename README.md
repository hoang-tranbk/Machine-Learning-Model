...
This project is the homework from a university subject, so it looks unprofessional and may takes the wrong.
The Word file "Dataset" is a report for the processing of this program, in the case you want to check.
Open the link below to enter Google Collaboration version of this project:
https://colab.research.google.com/drive/1-DNSgsHPtGtiRLVoTO_z1brLu5fz5wQ5#scrollTo=tYtKMeHIzTzx
Open the link below to enter Latex version of the report:
https://www.overleaf.com/project/692e312d6d6e5ee46251c2c1
